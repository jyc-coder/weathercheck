...
function WindDirection({ degree, ...props }) {
  switch (true) {
    ...
    case (22.5 <= degree && degree <= 45) || (45 <= degree && degree < 67.5):
      return <WiDirectionDownLeft {...props} />;
    case (67.5 <= degree && degree <= 90) || (90 <= degree && degree < 112.5):
      return <WiDirectionLeft {...props} />;
    case (112.5 <= degree && degree <= 135) ||
      (135 <= degree && degree < 157.5):
      return <WiDirectionUpLeft {...props} />;
    case (157.5 <= degree && degree <= 180) ||
      (180 <= degree && degree < 202.5):
      return <WiDirectionUp {...props} />;
    case (202.5 <= degree && degree <= 225) ||
      (225 <= degree && degree < 247.5):
      return <WiDirectionUpRight {...props} />;
    case (247.5 <= degree && degree <= 270) ||
      (270 <= degree && degree < 292.5):
      return <WiDirectionRight {...props} />;
    case (292.5 <= degree && degree <= 315) ||
      (315 <= degree && degree < 337.5):
